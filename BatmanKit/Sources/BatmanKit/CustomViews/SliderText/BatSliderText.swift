...
@available(iOS 10.0, *)
open class BatSliderText : UIView {
    
    open var pageControl : UIPageControl = UIPageControl(frame: CGRect(x: 0,y: 0,width: 50,height: 20))
    open var label : UILabel = UILabel(frame: CGRect(x: 0,y: 0,width: 50,height: 20))
    open var texts : [String] = ["Add your texts seperated by '|n'"]
